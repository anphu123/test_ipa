...
class EmailNotificationView extends GetView<EmailNotificationController> {
  const EmailNotificationView({super.key});
        ...
        child: Column(
          children: [
            _buildSection([
              ...
              _buildToggleItem(
                LocaleKeys.email_notification.trans(),
                subtitle:  LocaleKeys.account_notices.trans(),
            ...
            _buildSection([
              _buildToggleItem(
                ...
                subtitle:  LocaleKeys.upcoming_promotion.trans(),
              ),
              _buildToggleItem(
                LocaleKeys.survey.trans(),
                controller.isChatOn,
                subtitle:  LocaleKeys.accept_survey.trans(),
                isLast: true,
              ),
            ]),
