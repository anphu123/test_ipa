  ...
  void _startCountdown() {
    ...
    _countdownTimer = Timer.periodic(Duration(seconds: 1), (timer) {
      ...
      if (difference.isNegative) {
        ...
        remainingTime.value = '${days.toString().padLeft(2, '0')} ngày ${hours.toString().padLeft(2, '0')}:${minutes.toString().padLeft(2, '0')}:${seconds.toString().padLeft(2, '0')}';
      }
    });
  }
  
  OrderPurchaseAtStoreController get controller => Get.find<OrderPurchaseAtStoreController>();
      ...
      child: Column(
        ...
        children: [
          ...
          Row(
            children: [
              ...
              Container(
                ...
                child:Image.asset(Assets.images.pXiaomi15.path)
              ),
              SizedBox(width: 12.w),
              ...
              Expanded(
                child: Column(
                  ...
                  children: [
                    Text(
                      'Điện thoại/ Xiaomi/ Xiaomi 15 Ultra',
                      style: AppTypography.s14.medium.copyWith(
                        color: AppColors.neutral01,
                      ),
                    ),
          ...
          Obx(() {
            ...
            return Column(
              children: [
                _buildPriceRow('Giá ước tính', basePrice),
                if (selectedVoucher != null)
                  _buildPriceRow('Phiếu ưu đãi', voucherDiscount, isDiscount: true),
              ],
            );
          }),
                ...
                decoration: BoxDecoration(
                  gradient: LinearGradient(
                    ...
                    colors: [
                      Color(0xFFFF9A5C),
                      Color(0xFFFF6B35),
                     // Màu sáng hơn để tạo chuyển sắc
                    ],
                  ),
                  borderRadius: BorderRadius.circular(20.r),
                ),
                child: Obx(() => Text(
                  'Giá ưu đãi sẽ hết hạn sau ${remainingTime.value}',
      ...
      Container(
        ...
        child: Column(
          ...
          children: [
            ...
            // Product details
            _buildDetailRow('Tên sản phẩm', 'Xiaomi 15 Ultra'),
            _buildDetailRow('Dung lượng', '256GB'),
            _buildDetailRow('Phiên bản', 'Bản nội địa'),
            _buildDetailRow('Bảo hành', 'Thời hạn bảo hành >1 tháng'),
            _buildDetailRow('Tình trạng pin', 'Tốt (>80%)'),
            _buildDetailRow('Vỏ ngoài', 'Còn mới, không trầy xước'),
            _buildDetailRow('Màn hình', 'Hoạt động bình thường'),
            _buildDetailRow('Camera', 'Hoạt động tốt'),
            _buildDetailRow('Loa/Mic', 'Hoạt động bình thường'),
            _buildDetailRow('Các chức năng', 'Đầy đủ, hoạt động tốt'),
      ...
      child: Row(
        ...
        children: [
          ...
          Text(
            ...
            style: AppTypography.s14.regular.copyWith(
              color: isDiscount ? AppColors.error : AppColors.neutral01,
            ),
          ),
        ],
      ),
