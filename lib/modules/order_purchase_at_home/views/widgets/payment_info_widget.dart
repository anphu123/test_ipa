...
class PaymentInfoWidget extends GetView<OrderPurchaseAtHomeController> {
        ...
        children: [
          ...
          Row(
            children: [
              ...
              Expanded(
                child: Text(
                  LocaleKeys.atm_card_local.trans(),
...
Divider(color: AppColors.neutral07,),
          ...
          GestureDetector(
            ...
            child: Row(
              ...
              children: [
                Text(
                  LocaleKeys.add_other_payment_method.trans(),
        ...
        child: Column(
          ...
          children: [
            ...
            Row(
              ...
              children: [
                Text(
                  LocaleKeys.add_payment_method_title.trans(),
            ...
            _buildPaymentMethodItem(
              ...
              title: LocaleKeys.bank_account_title.trans(),
              subtitle: LocaleKeys.bank_account_desc.trans(),
              onTap: () {
                Get.back();
            ...
            _buildPaymentMethodItem(
              ...
              title: LocaleKeys.ewallet_title.trans(),
              subtitle: LocaleKeys.ewallet_desc.trans(),
              onTap: () {
                Get.back();
            ...
            _buildPaymentMethodItem(
              ...
              title: LocaleKeys.credit_card_title.trans(),
              subtitle: LocaleKeys.credit_card_desc.trans(),
              onTap: () {
                Get.back();
