...
class OrderStatusWidget extends GetView<OrderPurchaseAtHomeController> {
  ...
  Widget _buildScheduleInfo() {
    return RichText(
      text: TextSpan(
        ...
        children: [
          TextSpan(text: LocaleKeys.courier_will_arrive_on.trans(),style: AppTypography.s14.regular.withColor(AppColors.neutral01)),
          TextSpan(
            text:  controller.pickupDateTime,
            style: AppTypography.s14.regular.copyWith(
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          // Phone number
          Text(
          controller.customerName +' - ' + controller.customerPhone,
    ...
    return Column(
      children: [
        Container(
          ...
          height: 40.w,
          decoration: BoxDecoration(
            color: isCompleted ? AppColors.AS01 : AppColors.neutral06,
